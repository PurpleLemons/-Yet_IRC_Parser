...
server.route({
    ...
    s3Store.getBucket('static.andyet.com', '/irclogs', function _bucketInfo(err, bucketInfo) {
        ...
        //date.toLocaleTimeString() //For getting the time. It'll be on the very right part of the message area.
        ...
        logFile.push('<div style="width:200px; height:5000px; background-color:rgba(195, 195, 195, 0.4); position:fixed; top:0px; left:0px"></div>');
        ...
        s3Store.getObject('static.andyet.com/irclogs', '%26yet-'+strYear+'-'+strMonth+'-'+request.params.file.substring(3,5)+'.log', function _responseObject(err, response, fileBuf) {
            ...
            for(var i = 0; i < fileStr.length; i++)
            {
                ...
                if(fileStr[i].substring(20,24) == 'msg ')
                {
                    ...
                    if(nameChange == true)
                    {
                        tempArray.push("            <p><div class=\"name\"><em style=\"color:"+getColor(userN)+";\">"+userN+"</em></div><div class=\"msg\">"+fileStr[i].substring(msgStart,fileStr[i].length)+"</div></p>");
                    }
                    else
                    {
                ...
                if(fileStr[i].substring(20,24) == 'nick')
                {
                    ...
                    tempArray.push("                <p class=\"nick\"><em style=\"color:"+getColor(userN)+";\">" + userN + "</em> is now known as <em style=\"color:"+getColor(userN)+";\">" +
            ...
            logFile.push("<style>",
                         "div.name {text-align: left; margin-right:310px;}",
